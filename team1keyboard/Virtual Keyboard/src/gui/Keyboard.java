											 ...
											 if(list.getSelectedValue() != null){
												 if (wordAdded == false) {
													...
													try {
														...
														ProcessInput.processUserInput(keynames, points, list.getSelectedValue().toString());
														ProcessInput.processSokgraph(list.getSelectedValue().toString(),sokPoints, points);
														sokPoints.clear();
														points.clear();
														keynames.clear();
													} catch (IOException e) {
