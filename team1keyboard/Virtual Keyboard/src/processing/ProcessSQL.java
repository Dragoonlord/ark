...
public class ProcessSQL {
	 ...
	 * @throws SQLException
	 */
	public static void process(Word rawText,Location location, Word word) throws ClassNotFoundException, SQLException{
	 ...
	 * @throws SQLException
	 */
	public static void processSok(Sokgraph sok, Word word, Location coords) throws ClassNotFoundException, SQLException{
		// TODO Auto-generated method stub
		if(!SokgraphSQL.querySokgraphWord(sok)){
			SokgraphSQL.insertSokgraph(sok);
		}
	}
