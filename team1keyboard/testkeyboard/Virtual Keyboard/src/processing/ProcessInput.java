...
public class ProcessInput {
	 ...
	 * @throws IOException
	 */
	public static void processSokgraph(String str, ArrayList<Point> sokPnt, ArrayList<Point> coords, String userName) throws IOException{
		...
		try {
			ProcessSQL.processSok(sok,word,loc,userName);
	 ...
	 * @param user
	 */
	public static void processUserInput(ArrayList<String> str,ArrayList<Point> pnt, String user, String desiredWord){	
		...
		if(rawText != null && location != null && word != null){
			try {
				ProcessSQL.process(rawText,location, user, word);
			} catch (ClassNotFoundException | SQLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
